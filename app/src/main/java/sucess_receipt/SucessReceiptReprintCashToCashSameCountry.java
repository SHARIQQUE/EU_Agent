...
public class SucessReceiptReprintCashToCashSameCountry extends AppCompatActivity implements TaskCompleteToPrint {
    ...
    Double feesNull,feesAdd,totalAmount,amountAdd,totalFeesTax,tax;

    ComponentMd5SharedPre mComponentInfo;
   // String agentCode;

    Bundle bundle = new Bundle();
    String totalFeesTaxString,subscriberNoDestinationNo;
    ...
    SucessReceiptReprintCashToCashSameCountry.ConnectToPrinter connect_to_Printer;
    String printdata;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.success_reprint_cashtocash_samecountry);
        Toolbar mToolbar;
        Button printButton;
      ...
      //  agentCode = mComponentInfo.getmSharedPreferences().getString("agentCode", "");
        ...
        if(recieptData[6].equalsIgnoreCase("null") || recieptData[19].equalsIgnoreCase("null")) {
            feesNull = 0.0;
        ...
        else
        {
            ...
            tax = Double.parseDouble(recieptData[19]);


            totalFeesTax = (feesAdd+tax);
            totalFeesTaxString = Double.toString(totalFeesTax);


            feesRecepit.setText(totalFeesTaxString);
            amountRecepit.setText(recieptData[7]);

            amountAdd = Double.parseDouble(recieptData[7]);
            totalAmount = (amountAdd + totalFeesTax);
        ...
        currencyTypeReceipt.setText(recieptData[16]);
        ...
        transactionCodeRecepit.setText(recieptData[15]);
        attachBranceNameReceipt.setText(recieptData[12]);
        agentNameRecepit.setText(recieptData[17]);
        ...
        referenceNumber_textView.setText(recieptData[15]);

        oldTxnIdLL.setVisibility(View.VISIBLE);
        oldTxnidTextViewReceipt.setText(recieptData[18]);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptReprintCashToCashSameCountry.this.finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
                    if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                        connect_to_Printer = new SucessReceiptReprintCashToCashSameCountry.ConnectToPrinter();
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptReprintCashToCashSameCountry.this, mPrinter, bitMap, SucessReceiptReprintCashToCashSameCountry.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_ReprintcashToCashSameCountry(responseListForPrinter_Body);
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptReprintCashToCashSameCountry.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptReprintCashToCashSameCountry.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptReprintCashToCashSameCountry.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptReprintCashToCashSameCountry.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    SucessReceiptReprintCashToCashSameCountry.PrintToPrinter printToPrinter = new SucessReceiptReprintCashToCashSameCountry.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptReprintCashToCashSameCountry.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptReprintCashToCashSameCountry.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptReprintCashToCashSameCountry.this);
        try {
    ...
    private void generateAndSetData() {
        ...
        responseListForPrinter_Header.add(4, getString(R.string.cashtoCashImoneyReceipt));


        responseListForPrinter_Body.add(0, recieptData[18]);
        responseListForPrinter_Body.add(1, recieptData[15]);
        responseListForPrinter_Body.add(2, recieptData[11]);  // Sender name
        responseListForPrinter_Body.add(3, recieptData[10]);  // Sender Number
        responseListForPrinter_Body.add(4, recieptData[4]); //  Destination Country Camero  // // remove 02082017
        responseListForPrinter_Body.add(5, recieptData[9]);   //  Destination name
        responseListForPrinter_Body.add(6, recieptData[5]);  //  Destination number
        responseListForPrinter_Body.add(7, recieptData[16]);  //  currency Type Type

        if(recieptData[6].equalsIgnoreCase("null")|| recieptData[19].equalsIgnoreCase("null")) {
            recieptData[6] = "0.0";

            responseListForPrinter_Body.add(8, recieptData[7]);  // Amount
            responseListForPrinter_Body.add(9,  recieptData[6]);  // fees
            responseListForPrinter_Body.add(10, recieptData[7]);  // Total Amount

        }
        else
        {
            responseListForPrinter_Body.add(8, recieptData[7]);  // Amount
            responseListForPrinter_Body.add(9, totalFeesTaxString);  // fees
            responseListForPrinter_Body.add(10,totalAmountString);  // Total Amount

        }

        responseListForPrinter_Body.add(11, recieptData[17]);   //  agent Name
        responseListForPrinter_Body.add(12, recieptData[12]);   // Agnet branch Name
        responseListForPrinter_Body.add(13, recieptData[4]);  // Agent Country
        responseListForPrinter_Body.add(14, recieptData[2]);  // comment Country
    }

    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptReprintCashToCashSameCountry.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptReprintCashToCashSameCountry.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptReprintCashToCashSameCountry.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptReprintCashToCashSameCountry.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
