...
public class SucessReceiptCashOutSameBranch extends AppCompatActivity implements TaskCompleteToPrint {
    ...
    String agentCode, spinnerCountryString, agentName;
    ...
    SucessReceiptCashOutSameBranch.ConnectToPrinter connect_to_Printer;
    String printdata;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_cashout_same_brach);
        Toolbar mToolbar;
        ...
        try {
            if (recieptData.length > 11) {
                if (!recieptData[11].isEmpty() || !recieptData[11].equalsIgnoreCase("")) {
                    oldTxnIdLL.setVisibility(View.VISIBLE);
                    oldTxnidTextViewReceipt.setText(recieptData[11]);
                    titleTextView.setText(getString(R.string.cashOut_reprint));
                    txnType = 1;
                }
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptCashOutSameBranch.this.finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
                    if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                        connect_to_Printer = new SucessReceiptCashOutSameBranch.ConnectToPrinter();
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptCashOutSameBranch.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptCashOutSameBranch.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptCashOutSameBranch.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptCashOutSameBranch.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    SucessReceiptCashOutSameBranch.PrintToPrinter printToPrinter = new SucessReceiptCashOutSameBranch.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptCashOutSameBranch.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptCashOutSameBranch.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptCashOutSameBranch.this, mPrinter, bitMap,SucessReceiptCashOutSameBranch.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_cashOutSameBranch(responseListForPrinter_Body);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptCashOutSameBranch.this);
        try {
    ...
    private void generateAndSetData() {
        ...
        try {
            if (txnType == 1) {
                responseListForPrinter_Header.add(4, getString(R.string.cashOut_reprint));
                responseListForPrinter_Header.add(5, recieptData[11]);
            } else {
                responseListForPrinter_Header.add(4, getString(R.string.cashOutSameBranchReceipt));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptCashOutSameBranch.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptCashOutSameBranch.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptCashOutSameBranch.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptCashOutSameBranch.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
