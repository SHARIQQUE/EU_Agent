...
public class SucessReceiptReprintCashIn extends AppCompatActivity implements TaskCompleteToPrint {
    TextView dateRecepit, timeReceipt, transactionIdReceipt, subscriberNumberReceipt, subscribeNameReceipt,
    ...
    String[] recieptData;
    String totalAmountString,totalTaxString;
    Double feesNull,feesAdd,totalAmount,amountAdd,TaxAmount,TotalTaxAdd;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_reprint_cash_in);
        Toolbar mToolbar;
     ...
     //   agentName = mComponentInfo.getmSharedPreferences().getString("agentName", "");
      ...
      //  stateNameString = mComponentInfo.getmSharedPreferences().getString("stateNameString", "");
        ...
        /*9293932|Transaction Successful|comments|04/07/2017 09:13:22|Cameroon|237741741741|419.0|600||AbangMinkoo|test|9293931*/
        ...
        oldTxnidTextViewReceipt.setText(recieptData[10]);
        ...
        else
        {
            ...
            TaxAmount = Double.parseDouble(recieptData[14]);

            TotalTaxAdd=TaxAmount+feesAdd;
            totalTaxString = Double.toString(TotalTaxAdd);
            feesRecepit.setText(totalTaxString);


            //totalAmountTaxFeesString

            totalAmount = (amountAdd - TotalTaxAdd);
        ...
        subscribeNameReceipt.setText(recieptData[12]);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptReprintCashIn.this.finish();
            }
        });
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptReprintCashIn.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptReprintCashIn.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptReprintCashIn.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptReprintCashIn.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptReprintCashIn.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptReprintCashIn.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptReprintCashIn.this, mPrinter, bitMap, SucessReceiptReprintCashIn.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_ReprintCashIn(responseListForPrinter_Body);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptReprintCashIn.this);
        try {
    ...
    private void generateAndSetData() {
        ...
        responseListForPrinter_Header.add(4, getString(R.string.cashIn_reprint));


        responseListForPrinter_Body.add(0, recieptData[10]);
        responseListForPrinter_Body.add(1, recieptData[5]);
        responseListForPrinter_Body.add(2, recieptData[12]);
        responseListForPrinter_Body.add(3, recieptData[8]);
        responseListForPrinter_Body.add(4, recieptData[9]);
        responseListForPrinter_Body.add(5, recieptData[4]);


        if(recieptData[6].equalsIgnoreCase("null")) {
            recieptData[6] = "0.0";

            responseListForPrinter_Body.add(6, recieptData[7]);
            responseListForPrinter_Body.add(7, recieptData[6]);
        }
        else
        {
            responseListForPrinter_Body.add(6, totalAmountString);
            responseListForPrinter_Body.add(7, totalTaxString);
        }

        responseListForPrinter_Body.add(8, recieptData[11]);
        responseListForPrinter_Body.add(9, recieptData[4]);
    }

    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptReprintCashIn.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptReprintCashIn.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptReprintCashIn.this, new String[]{permission}, requestCode);
    ...
    private boolean mayRequestPhoneState() {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptReprintCashIn.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
