...
public class SucessReceiptSendMoneyToMobile extends AppCompatActivity implements TaskCompleteToPrint {
  ...
  int amountPrintbuttonhide;
    ...
    SucessReceiptSendMoneyToMobile.ConnectToPrinter connect_to_Printer;
    String printdata;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_sendmoney_tomobile);
        Toolbar mToolbar;
...
//        String aa = getIntent().getExtras().getString("data", "");
        ...
        {
            generateAndSetDataConfodeDisplay();
        }

        else {

             linearlayout_confcode.setVisibility(View.GONE);
             generateAndSetDataConfodeHide();
        }
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptSendMoneyToMobile.this.finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
                    if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                        connect_to_Printer = new SucessReceiptSendMoneyToMobile.ConnectToPrinter();
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptSendMoneyToMobile.this, mPrinter, bitMap, SucessReceiptSendMoneyToMobile.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);


            if(showconfcode.equalsIgnoreCase("1"))
            {
                mPrintUtils.print_SendMoneyToMobile_ConfcodeDisplay(responseListForPrinter_Body);
            }

            else {
                  mPrintUtils.print_SendMoneyToMobile_ConfcodeHide(responseListForPrinter_Body);
                }
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptSendMoneyToMobile.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptSendMoneyToMobile.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptSendMoneyToMobile.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptSendMoneyToMobile.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    SucessReceiptSendMoneyToMobile.PrintToPrinter printToPrinter = new SucessReceiptSendMoneyToMobile.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptSendMoneyToMobile.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptSendMoneyToMobile.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptSendMoneyToMobile.this);
        try {
    ...
    private void generateAndSetDataConfodeHide() {
        ...
        responseListForPrinter_Body.add(1, recieptData[10]);  // Sender Number
        responseListForPrinter_Body.add(2, destinationNameAgentIdentity);   //  Destination name
        responseListForPrinter_Body.add(3, destinationNoString);  //  Destination number
        ...
        responseListForPrinter_Body.add(9, recieptData[12]);   // Agnet branch Name
        responseListForPrinter_Body.add(10, recieptData[4]);  // Agent Country
        responseListForPrinter_Body.add(11, commentString);  // comment Country


    }

    private void generateAndSetDataConfodeDisplay() {
        ...
        responseListForPrinter_Body.add(12, commentString);  // comment Country
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptSendMoneyToMobile.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptSendMoneyToMobile.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptSendMoneyToMobile.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptSendMoneyToMobile.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
