...
public class SucessReceiptReprintCashOut extends AppCompatActivity implements TaskCompleteToPrint {
    ...
    SucessReceiptReprintCashOut.ConnectToPrinter connect_to_Printer;
    String printdata;
    ...
    Bitmap bitMap;
    Double FeesDouble,TaxDouble;

    String totalAmountString,totalTaxString,totalAmountTaxFeesString;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_reprint_cashout);
        Toolbar mToolbar;
        ...
        mToolbar = (Toolbar) findViewById(R.id.tool_bar_transactionReceiptCashOut);
      ...
      //  spinnerCountryString = mComponentInfo.getmSharedPreferences().getString("spinnerCountryString", "");
        ...
        //9289860|Transaction Successful|comments|21/06/2017 08:48:58|Cameroon|237741741741|300.0|1500|EU BUEA I|AbangMinkoo|test
        ...
        TaxAmount = Double.parseDouble(recieptData[13]);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptReprintCashOut.this.finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
                    if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                        connect_to_Printer = new SucessReceiptReprintCashOut.ConnectToPrinter();
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptReprintCashOut.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptReprintCashOut.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptReprintCashOut.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptReprintCashOut.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    SucessReceiptReprintCashOut.PrintToPrinter printToPrinter = new SucessReceiptReprintCashOut.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptReprintCashOut.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptReprintCashOut.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptReprintCashOut.this, mPrinter, bitMap, SucessReceiptReprintCashOut.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_reprint_cashOut(responseListForPrinter_Body);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptReprintCashOut.this);
        try {
    ...
    private void generateAndSetData() {
        ...
        responseListForPrinter_Header.add(4, getString(R.string.cashOutreprint_new));


        responseListForPrinter_Body.add(0, recieptData[12]);   // Subscriber number
        responseListForPrinter_Body.add(1, recieptData[5]);   // Subscriber number
        responseListForPrinter_Body.add(2, recieptData[10]);  // Subscriber name
        responseListForPrinter_Body.add(3, recieptData[8]);   // Attach Branch name
        responseListForPrinter_Body.add(4, recieptData[9]);  // City number
        responseListForPrinter_Body.add(5, recieptData[4]);  // Country
        responseListForPrinter_Body.add(6, recieptData[7]);  // Amount
        responseListForPrinter_Body.add(7, totalTaxString);  // fees
        responseListForPrinter_Body.add(8, recieptData[11]);  // Agent NAme
        responseListForPrinter_Body.add(9, recieptData[4]);   // Agent Country
    }

    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptReprintCashOut.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptReprintCashOut.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptReprintCashOut.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptReprintCashOut.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
