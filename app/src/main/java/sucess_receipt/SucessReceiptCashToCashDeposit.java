...
public class SucessReceiptCashToCashDeposit extends AppCompatActivity implements TaskCompleteToPrint {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_cashtocash_deposit);
        Toolbar mToolbar;
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptCashToCashDeposit.this.finish();
            }
        });
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptCashToCashDeposit.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptCashToCashDeposit.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptCashToCashDeposit.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptCashToCashDeposit.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptCashToCashDeposit.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptCashToCashDeposit.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptCashToCashDeposit.this, mPrinter, bitMap, SucessReceiptCashToCashDeposit.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_imoney_deposit(responseListForPrinter_Body);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptCashToCashDeposit.this);
        try {
    ...
    private void generateAndSetData() {
        ...
        responseListForPrinter_Header.add(4, getString(R.string.cashfortransfer_deposit));
        ...
        responseListForPrinter_Body.add(5, spinnerCountryString);     // agent Country
        responseListForPrinter_Body.add(6, recieptData[6]);   //  branach name
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptCashToCashDeposit.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptCashToCashDeposit.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptCashToCashDeposit.this, new String[]{permission}, requestCode);
    ...
    private boolean mayRequestPhoneState() {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptCashToCashDeposit.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
