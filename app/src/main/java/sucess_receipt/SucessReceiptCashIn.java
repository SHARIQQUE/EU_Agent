...
public class SucessReceiptCashIn extends AppCompatActivity implements TaskCompleteToPrint {
    TextView dateRecepit, timeReceipt, transactionIdReceipt, subscriberNumberReceipt, subscribeNameReceipt,
            ...
            agentCountryRecepit, oldTxnidTitleTextViewReceipt, oldTxnidTextViewReceipt, titleTextView,commentsRecepit;
    Button homeButton, printButton;
    String[] recieptData;
    Double feesNull,feesAdd,totalAmount,amountAdd;
   String comment_cashin="";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_cash_in);
        Toolbar mToolbar;
        ...
        commentsRecepit = (TextView) findViewById(R.id.commentsRecepit);
        ...
        comment_cashin = mComponentInfo.getmSharedPreferences().getString("comment_cashin", "");


        commentsRecepit.setText(comment_cashin);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptCashIn.this.finish();
            }
        });
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptCashIn.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptCashIn.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptCashIn.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptCashIn.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptCashIn.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptCashIn.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptCashIn.this, mPrinter, bitMap,SucessReceiptCashIn.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_CashIn(responseListForPrinter_Body);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptCashIn.this);
        try {
    ...
    private void generateAndSetData() {
        ...
        try {
            if (txnType == 1) {
                ...
                responseListForPrinter_Header.add(4, getString(R.string.cashiInReceiptpage));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }

        responseListForPrinter_Body.add(0, recieptData[5]);
        responseListForPrinter_Body.add(1, recieptData[10]);
        responseListForPrinter_Body.add(2, recieptData[8]);
        responseListForPrinter_Body.add(3, stateNameString);
        responseListForPrinter_Body.add(4, spinnerCountryString);


        if(tariffAmountFee.equalsIgnoreCase("null")) {
            tariffAmountFee = "0.0";

            responseListForPrinter_Body.add(5, recieptData[7]);
            responseListForPrinter_Body.add(6, tariffAmountFee);
        }
        else
        {
            responseListForPrinter_Body.add(5, totalAmountString);
            responseListForPrinter_Body.add(6, tariffAmountFee);
        }

        responseListForPrinter_Body.add(7, comment_cashin);
        responseListForPrinter_Body.add(8, agentName);
        responseListForPrinter_Body.add(9, recieptData[4]);
    }

    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptCashIn.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptCashIn.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptCashIn.this, new String[]{permission}, requestCode);
    ...
    private boolean mayRequestPhoneState() {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptCashIn.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
