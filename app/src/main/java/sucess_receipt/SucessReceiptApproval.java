...
public class SucessReceiptApproval extends AppCompatActivity implements TaskCompleteToPrint {
    ...
    String[] recieptData, printRecieptDataArray;
    ...
    String agentCode, agentName, transType, approvalType, receiptPrintData;
    ...
    ArrayList<String> responseListForPrinter_Header, responseListForPrinter_Body_printReceipt, responseListForPrinter_Body_ReceiveMoney_transactionApproval, responseListForPrinter_Body_CashtoM_transactionApproval, responseListForPrinter_Body_SendMoney_transactionApproval, responseListForPrinter_Body_CashIn_CashOut_transactionApproval;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_approval);
        Toolbar mToolbar;
        ...
        transType = mComponentInfo.getmSharedPreferences().getString("transType", "");
        //transTypeTextView.setText(transType);
        agentCode = mComponentInfo.getmSharedPreferences().getString("agentCode", "");
        agentName = mComponentInfo.getmSharedPreferences().getString("agentName", "");
        receiptPrintData = mComponentInfo.getmSharedPreferences().getString("data", "");
        ...
        switch (transType) {
            ...
            case "CASHIN":   //  done
                ...
                if (transType.equalsIgnoreCase("CASHIN")) ;
            {
                approvalType = "CASHIN";

                transType = getString(R.string.cashin_approve);
            ...
            attachBranceNameReceipt.setText(recieptData[10]);
            subscribeNameReceipt.setText(recieptData[15]);
            agentNameRecepit.setText(agentName);
            agentCountryRecepit.setText(recieptData[4]);

            generateAndSetDataCashinCashOut();

            break;

            case "CASHOUT":    //  done

                if (transType.equalsIgnoreCase("CASHOUT")) ;
            {

                approvalType = "CASHOUT";

                transType = getString(R.string.cashout_approve);
            }
            transTypeTextView.setText(transType);
            ...
            case "CASHTOM":  // fees not configure

                if (transType.equalsIgnoreCase("CASHTOM")) ;
            {

                approvalType = "CASHTOM";


                transType = getString(R.string.cashtoM_approve);
            }
            ...
            marchantNameTextView.setText(recieptData[17]);   // only set Server Data
            linearLayoutBillNumber.setVisibility(View.VISIBLE);
            billNumberReceiptTextView.setText("");  // Bill Number  tag is not coming From Server number
            LinearLayoutLabelName.setVisibility(View.VISIBLE);
            labelNameTextView.setText(recieptData[18]);    // only set Server Data
            linearLayoutDestinationName.setVisibility(View.VISIBLE);
            destinationNameTextView.setText(recieptData[15]);   // only set Server Data
            linearLayoutSenderNameCashToMarchant.setVisibility(View.VISIBLE);
            senderNameCashToMerchantTextView.setText(recieptData[11]);    // only set Server Data
            ...
            agentBrancehNameTextView.setText(recieptData[10]);    //  null Value From Server
            agentCountryRecepit.setText(recieptData[4]);   //   only set Data From  Server Data

            linearLayout_comments.setVisibility(View.VISIBLE);
            comment_textView.setText(recieptData[2]);
            //transactionCode_textview.setText(recieptData[14]);
            linearLayout_totalAmount.setVisibility(View.VISIBLE);
            transactionCode_textview.setText(recieptData[14]);


            generateAndSetDataCashToMerchat();

            break;

            case "REMTSEND":  // done

                if (transType.equalsIgnoreCase("REMTSEND")) ;
            {

                approvalType = "REMTSEND";

                transType = getString(R.string.sendMoney_approve);
            }

            transTypeTextView.setText(transType);
            linearLayoutSenderName.setVisibility(View.VISIBLE);
            linearLayoutSenderNumber.setVisibility(View.VISIBLE);
            linearLayoutDestinationName.setVisibility(View.VISIBLE);
            linearLayoutDestinationNumber.setVisibility(View.VISIBLE);
            linearLayoutDestinationCountry.setVisibility(View.VISIBLE);
            linearLayout_totalAmount.setVisibility(View.VISIBLE);
            linearLayout_agentBrancehName.setVisibility(View.VISIBLE);
            ...
            linearLayout_currency.setVisibility(View.VISIBLE);
            currency_TextView.setText(recieptData[16]);      // Tag is not available in server Response
            linearlayout_subscriberNumber.setVisibility(View.GONE);
            linearlayout_subscriberName.setVisibility(View.GONE);
            linearLayout_attachedBranch_name.setVisibility(View.GONE);
            linearLayout_city.setVisibility(View.GONE);
            countryRecepit.setText(recieptData[4]);
            senderNameTextView.setText(recieptData[11]); // null Value From Server
            senderNumberTextView.setText(recieptData[12]);
            destinationNameTextView.setText(recieptData[15]);// Tag is not available in server Response
            destinationNumberTextView.setText(recieptData[5]);
            feesRecepit.setText(recieptData[6]);
            amountRecepit.setText(recieptData[7]);
            cityReceipt.setText(recieptData[9]);
            agentBrancehNameTextView.setText(recieptData[10]);    //  null Value From Server
            agentNameRecepit.setText(agentName);
            agentCountryRecepit.setText(recieptData[4]);
            destinaytionCountryTextView.setText(recieptData[4]);          // Tag is not available in server Response


            showconfcode=recieptData[19];
            ...
            if(showconfcode.equalsIgnoreCase("1"))
            {
                ...
                sendMoneyApprovalConfcodeDisplay();
            }

            else if(showconfcode.equalsIgnoreCase("0")){
                linearLayout_transactionCode.setVisibility(View.GONE);
                sendMoneyApprovalConfcodeHide();
            }

            else if(showconfcode.equalsIgnoreCase("")){
                linearLayout_transactionCode.setVisibility(View.GONE);
                sendMoneyApprovalConfcodeHide();
            }
            ...
            case "REMTRECV":    // Fees Not Configure

                if (transType.equalsIgnoreCase("REMTRECV")) ;
            {
                approvalType = "REMTRECV";

                transType = getString(R.string.receiveMoney_approve);
            }

            transTypeTextView.setText(transType);

            linearLayoutSenderName.setVisibility(View.GONE);
            linearLayoutSenderNumber.setVisibility(View.GONE);
            linearLayoutDestinationName.setVisibility(View.VISIBLE);
            linearLayoutDestinationNumber.setVisibility(View.VISIBLE);
            linearLayoutDestinationCountry.setVisibility(View.VISIBLE);
            linearLayout_totalAmount.setVisibility(View.VISIBLE);
            ...
            linearLayout_transactionCode.setVisibility(View.VISIBLE);
            linearLayout_currency.setVisibility(View.VISIBLE);
            currency_TextView.setText(recieptData[15]);      // Tag is not available in server Response
            linearlayout_subscriberNumber.setVisibility(View.GONE);
            linearlayout_subscriberName.setVisibility(View.GONE);
            linearLayout_attachedBranch_name.setVisibility(View.GONE);
            linearLayout_city.setVisibility(View.GONE);
            ...
            agentCountryRecepit.setText(recieptData[4]);
            //transactionCode_textview.setText(recieptData[14]);
            destinaytionCountryTextView.setText("");          // Tag is not available in server Response

            generateAndSetDataReceiveMoney();
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptApproval.this.finish();
            }
        });
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptApproval.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptApproval.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptApproval.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptApproval.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptApproval.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptApproval.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptApproval.this, mPrinter, bitMap, SucessReceiptApproval.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);

            switch (approvalType) {

                case "CASHIN":   //  Success
                    mPrintUtils.print_CashIn_cashOut_TransactionApproval(responseListForPrinter_Body_CashIn_CashOut_transactionApproval);
                    break;
                ...
                case "CASHTOM":
                    ...
                    mPrintUtils.print_approval_cashToM(responseListForPrinter_Body_CashtoM_transactionApproval);
                ...
                case "REMTSEND":
                    ...
                    if(showconfcode.equalsIgnoreCase("1"))
                    {
                        mPrintUtils.print_SendMoney_transactionApproval_confcodeDisplay(responseListForPrinter_Body_SendMoney_transactionApproval);
                    }

                    else if(showconfcode.equalsIgnoreCase("0"))
                    {
                        mPrintUtils.print_SendMoney_transactionApproval_confcodeHide(responseListForPrinter_Body_SendMoney_transactionApproval);
                    }
                ...
                case "REMTRECV":
                    mPrintUtils.print_ReceiveMoney_transactionApproval(responseListForPrinter_Body_ReceiveMoney_transactionApproval);
                    break;
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptApproval.this);
        try {
    ...
    private void generateAndSetDataPrintReceipt() {
        ...
        responseListForPrinter_Header.add(1, printRecieptDataArray[3].split("\\ ")[0]);
        responseListForPrinter_Header.add(2, printRecieptDataArray[3].split("\\ ")[1]);
        responseListForPrinter_Header.add(3, printRecieptDataArray[0]);
        responseListForPrinter_Header.add(4, "RECEIPT");

        //  cvcccvvcv

        responseListForPrinter_Body_printReceipt = new ArrayList<String>();

        responseListForPrinter_Body_printReceipt.add(0, printRecieptDataArray[14]);    // Merchant Name
        responseListForPrinter_Body_printReceipt.add(1, printRecieptDataArray[10]);   // Bill NUmber
        responseListForPrinter_Body_printReceipt.add(2, printRecieptDataArray[13]);    // Label name
        responseListForPrinter_Body_printReceipt.add(3, printRecieptDataArray[6]);    // Destination name
        responseListForPrinter_Body_printReceipt.add(4, printRecieptDataArray[8]);   //  sender name


        if (recieptData[4].equalsIgnoreCase("null")) {
            recieptData[6] = "0.0";

            responseListForPrinter_Body_printReceipt.add(5, printRecieptDataArray[5]);  // Amount
            responseListForPrinter_Body_printReceipt.add(6, recieptData[6]);  // fees
            responseListForPrinter_Body_printReceipt.add(7, printRecieptDataArray[5]);  // Total Amount

        } else {

            responseListForPrinter_Body_printReceipt.add(5, printRecieptDataArray[5]);   // amount
            responseListForPrinter_Body_printReceipt.add(6, printRecieptDataArray[4]);   // fees
            responseListForPrinter_Body_printReceipt.add(7, totalAmountString);   // total amount


        }


        responseListForPrinter_Body_printReceipt.add(8, transactionCodeString);   // transaction Code
        responseListForPrinter_Body_printReceipt.add(9, agentName);                   // agent name
        responseListForPrinter_Body_printReceipt.add(10, printRecieptDataArray[9]);   // agent Brance Name
        responseListForPrinter_Body_printReceipt.add(11, printRecieptDataArray[12]);   // agent Country
        responseListForPrinter_Body_printReceipt.add(12, printRecieptDataArray[2]);   // Comments
    }

    private void generateAndSetDataCashinCashOut() {
        ...
        responseListForPrinter_Body_CashIn_CashOut_transactionApproval = new ArrayList<String>();
        responseListForPrinter_Header = new ArrayList<String>();
        ...
        responseListForPrinter_Header.add(4, transType);


        responseListForPrinter_Body_CashIn_CashOut_transactionApproval.add(0, recieptData[5]);   // Subscriber Number
        responseListForPrinter_Body_CashIn_CashOut_transactionApproval.add(1, recieptData[15]);  // Subscriber Name
        responseListForPrinter_Body_CashIn_CashOut_transactionApproval.add(2, recieptData[10]);   // Attach Branch Name:
        responseListForPrinter_Body_CashIn_CashOut_transactionApproval.add(3, recieptData[9]);
        responseListForPrinter_Body_CashIn_CashOut_transactionApproval.add(4, recieptData[4]);
        responseListForPrinter_Body_CashIn_CashOut_transactionApproval.add(5, recieptData[7]);
        responseListForPrinter_Body_CashIn_CashOut_transactionApproval.add(6, recieptData[6]);
        responseListForPrinter_Body_CashIn_CashOut_transactionApproval.add(7, agentName);
        responseListForPrinter_Body_CashIn_CashOut_transactionApproval.add(8, recieptData[4]);
    }

    private void sendMoneyApprovalConfcodeDisplay() {


        int a = recieptData.length;
        responseListForPrinter_Body_SendMoney_transactionApproval = new ArrayList<String>();
        responseListForPrinter_Header = new ArrayList<String>();
        ...
        responseListForPrinter_Body_SendMoney_transactionApproval.add(0, recieptData[11]);  // sender Name
        responseListForPrinter_Body_SendMoney_transactionApproval.add(1, recieptData[12]);  // Sdnder Mobile Number
        responseListForPrinter_Body_SendMoney_transactionApproval.add(2, recieptData[4]);              // Destination Country null
        responseListForPrinter_Body_SendMoney_transactionApproval.add(3, recieptData[15]);            // Destination name null
        responseListForPrinter_Body_SendMoney_transactionApproval.add(4, recieptData[5]);  // Destination Number null
        responseListForPrinter_Body_SendMoney_transactionApproval.add(5, recieptData[16]);             // Currency  null
        responseListForPrinter_Body_SendMoney_transactionApproval.add(6, recieptData[7]);  // Amount
        responseListForPrinter_Body_SendMoney_transactionApproval.add(7, recieptData[6]);  // fee
        responseListForPrinter_Body_SendMoney_transactionApproval.add(8, totalAmountString);  // total anount
        responseListForPrinter_Body_SendMoney_transactionApproval.add(9, recieptData[14]); // transaction code
        responseListForPrinter_Body_SendMoney_transactionApproval.add(10, agentName);    // agent NAme
        responseListForPrinter_Body_SendMoney_transactionApproval.add(11, recieptData[10]);   // Agent Branch  null Value From Server
        responseListForPrinter_Body_SendMoney_transactionApproval.add(12, recieptData[4]);  // agent  country


    }

    private void sendMoneyApprovalConfcodeHide() {
        ...
        responseListForPrinter_Body_SendMoney_transactionApproval.add(7, recieptData[6]);  // fee
        responseListForPrinter_Body_SendMoney_transactionApproval.add(8, totalAmountString);  // total anount
        responseListForPrinter_Body_SendMoney_transactionApproval.add(9, agentName);    // agent NAme
        responseListForPrinter_Body_SendMoney_transactionApproval.add(10, recieptData[10]);   // Agent Branch  null Value From Server
        responseListForPrinter_Body_SendMoney_transactionApproval.add(11, recieptData[4]);  // agent  country


    }


    private void generateAndSetDataCashToMerchat() {

        int a = recieptData.length;


        responseListForPrinter_Body_CashtoM_transactionApproval = new ArrayList<String>();
    ...
    private void generateAndSetDataReceiveMoney() {

        int a = recieptData.length;
        responseListForPrinter_Body_ReceiveMoney_transactionApproval = new ArrayList<String>();
        responseListForPrinter_Header = new ArrayList<String>();
        ...
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(0, recieptData[4]);   //  Destination Country null
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(1, recieptData[15]);     //  Destination name null
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(2, recieptData[5]);    //  Destination Number
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(3, recieptData[15]); // Currency  null
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(4, recieptData[7]);        // Amount
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(5, recieptData[6]);    // fees
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(6, totalAmountString);  // Total Amount
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(7, agentName);           // Agent Name
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(8, recieptData[10]);     // Agent Branch NAme
        responseListForPrinter_Body_ReceiveMoney_transactionApproval.add(9, recieptData[4]); // Agent Country
    }


    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptApproval.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptApproval.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptApproval.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptApproval.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
