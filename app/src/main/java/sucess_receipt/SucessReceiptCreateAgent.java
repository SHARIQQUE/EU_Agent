...
public class SucessReceiptCreateAgent extends AppCompatActivity implements TaskCompleteToPrint {
...
LinearLayout oldTxnIdLL;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_create_agent);
        Toolbar mToolbar;
       ...
       // String aa = getIntent().getExtras().getString("data", "");
        ...
        try {
            if (recieptData.length > 8) {
                if (!recieptData[8].isEmpty() || !recieptData[8].equalsIgnoreCase("")) {
                    oldTxnIdLL.setVisibility(View.VISIBLE);
                    oldTxnidTextViewReceipt.setText(recieptData[8]);
                    titleTextView.setText(getString(R.string.reprintCreateAgent));
                    txnType = 1;
                }
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptCreateAgent.this.finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
                    if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                        connect_to_Printer = new SucessReceiptCreateAgent.ConnectToPrinter();
    ...
    private void generateAndSetData() {
        ...
        responseListForPrinter_Body.add(1, recieptData[7]);   //  Subscriber Name
        responseListForPrinter_Body.add(2, recieptData[6]);   //  Attach Branch name
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptCreateAgent.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptCreateAgent.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptCreateAgent.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptCreateAgent.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    SucessReceiptCreateAgent.PrintToPrinter printToPrinter = new SucessReceiptCreateAgent.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptCreateAgent.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptCreateAgent.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptCreateAgent.this, mPrinter, bitMap,SucessReceiptCreateAgent.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_CreateAgent(responseListForPrinter_Body);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptCreateAgent.this);
        try {
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptCreateAgent.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptCreateAgent.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptCreateAgent.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptCreateAgent.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
