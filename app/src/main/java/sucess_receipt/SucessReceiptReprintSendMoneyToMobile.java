...
public class SucessReceiptReprintSendMoneyToMobile extends AppCompatActivity implements TaskCompleteToPrint {
    ...
    SucessReceiptReprintSendMoneyToMobile.ConnectToPrinter connect_to_Printer;
    String printdata;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_reprint_sendmoney_tomobile);
        Toolbar mToolbar;
        Button printButton;
...
//        String aa = getIntent().getExtras().getString("data", "");
      ...
      //  "" = mComponentInfo.getmSharedPreferences().getString("""", "");
      ...
      //  commentString = mComponentInfo.getmSharedPreferences().getString("commentString", "");
        ...
        /*try {
            if (recieptData.length > 18) {
                if (!recieptData[18].isEmpty() || !recieptData[18].equalsIgnoreCase("")) {
        ...
        currencyTypeReceipt.setText(recieptData[18]);                       // coming from Server
       ...
       // transactionCodeRecepit.setText(recieptData[14]);
        ...
        agentNameRecepit.setText(recieptData[16]);
...
*/
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptReprintSendMoneyToMobile.this.finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
                    if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                        connect_to_Printer = new SucessReceiptReprintSendMoneyToMobile.ConnectToPrinter();
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptReprintSendMoneyToMobile.this, mPrinter, bitMap, SucessReceiptReprintSendMoneyToMobile.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_ReprintSendMoneyToMobile(responseListForPrinter_Body);
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptReprintSendMoneyToMobile.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptReprintSendMoneyToMobile.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptReprintSendMoneyToMobile.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptReprintSendMoneyToMobile.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    SucessReceiptReprintSendMoneyToMobile.PrintToPrinter printToPrinter = new SucessReceiptReprintSendMoneyToMobile.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptReprintSendMoneyToMobile.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptReprintSendMoneyToMobile.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptReprintSendMoneyToMobile.this);
        try {
    ...
    private void generateAndSetData() {
        ...
        responseListForPrinter_Header.add(4, getString(R.string.sendMoneyReprint));


        responseListForPrinter_Body.add(0, recieptData[17]);  // Sender name
        responseListForPrinter_Body.add(1, recieptData[11]);  // Sender name
        ...
        responseListForPrinter_Body.add(5, recieptData[18]);  //  currency Type Type
        ...
        {
            responseListForPrinter_Body.add(6, totalAmountString);  // Amount
            responseListForPrinter_Body.add(7, recieptData[6]);  // fees
            responseListForPrinter_Body.add(8, recieptData[7]);  // Total Amount
      ...
      //  responseListForPrinter_Body.add(8, recieptData[14]); // Transaction Code
        responseListForPrinter_Body.add(9, recieptData[16]);   //  agent Name
        ...
        responseListForPrinter_Body.add(12, recieptData[2]);  // comment Country
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptReprintSendMoneyToMobile.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptReprintSendMoneyToMobile.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptReprintSendMoneyToMobile.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptReprintSendMoneyToMobile.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
