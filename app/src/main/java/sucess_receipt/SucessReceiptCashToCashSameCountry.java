...
public class SucessReceiptCashToCashSameCountry extends AppCompatActivity implements TaskCompleteToPrint {
    ...
    SucessReceiptCashToCashSameCountry.ConnectToPrinter connect_to_Printer;
    String printdata;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.success_receipt_cashtocash_samecountry);
        Toolbar mToolbar;
        Button printButton;
...
//        String aa = getIntent().getExtras().getString("data", "");
        ...
        referenceNumber_textView.setText(recieptData[12]);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptCashToCashSameCountry.this.finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
                    if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                        connect_to_Printer = new SucessReceiptCashToCashSameCountry.ConnectToPrinter();
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptCashToCashSameCountry.this, mPrinter, bitMap, SucessReceiptCashToCashSameCountry.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_cashToCashSameCountry(responseListForPrinter_Body);
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptCashToCashSameCountry.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptCashToCashSameCountry.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptCashToCashSameCountry.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptCashToCashSameCountry.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    SucessReceiptCashToCashSameCountry.PrintToPrinter printToPrinter = new SucessReceiptCashToCashSameCountry.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptCashToCashSameCountry.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptCashToCashSameCountry.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptCashToCashSameCountry.this);
        try {
    ...
    private void generateAndSetData() {
        ...
        responseListForPrinter_Header.add(4, getString(R.string.sendCash_slip));


        responseListForPrinter_Body.add(0, recieptData[12]);
        responseListForPrinter_Body.add(1, SenderNameAgentIdentity);  // Sender name
        responseListForPrinter_Body.add(2, recieptData[10]);  // Sender Number
        responseListForPrinter_Body.add(3, recieptData[14]); //  Destination Country Camero  // // remove 02082017
        responseListForPrinter_Body.add(4, destinationNameAgentIdentity);   //  Destination name
        responseListForPrinter_Body.add(5, destinationNoString);  //  Destination number
        responseListForPrinter_Body.add(6, spinnerCurrenceyString);  //  currency Type Type

        if(recieptData[6].equalsIgnoreCase("null")) {
            recieptData[6] = "0.0";

            responseListForPrinter_Body.add(7, recieptData[7]);  // Amount
            responseListForPrinter_Body.add(8, recieptData[6]);  // fees
            responseListForPrinter_Body.add(9, recieptData[7]);  // Total Amount
        ...
        else
        {
            responseListForPrinter_Body.add(7, recieptData[7]);  // Amount
            responseListForPrinter_Body.add(8, recieptData[6]);  // fees
            responseListForPrinter_Body.add(9, totalAmountString);  // Total Amount

        }

        responseListForPrinter_Body.add(10, agentName);   //  agent Name
        responseListForPrinter_Body.add(11, recieptData[13]);   // Agnet branch Name
        responseListForPrinter_Body.add(12, recieptData[14]);  // Agent Country
        responseListForPrinter_Body.add(13, commentString);  // comment Country
    }

    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptCashToCashSameCountry.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptCashToCashSameCountry.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptCashToCashSameCountry.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptCashToCashSameCountry.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
