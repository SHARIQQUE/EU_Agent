...
public class SucessReceiptBillPay extends AppCompatActivity implements TaskCompleteToPrint {
    ...
    Double feesNull,amountAdd,feesAdd,tempdata;
    ...
    SucessReceiptBillPay.ConnectToPrinter connect_to_Printer;
    String printdata;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(recieptData[17].equalsIgnoreCase("SUB"))   //
        {

                if(feesBillPay.equalsIgnoreCase("null"))
                {
                    feesNull = 0.0;
                ...
                {
                    amountAdd = Double.parseDouble(amountBillPay);
                    feesAdd = Double.parseDouble(feesBillPay);
                    tempdata = (amountAdd + feesAdd);
                    totalAmountString = Double.toString(tempdata);
                    totalamountRecepit.setText(totalAmountString);
                    amountRecepit.setText(amountBillPay);
                    feesRecepit.setText(feesBillPay);
        ...
        if(recieptData[17].equalsIgnoreCase("MER"))   //  amount - fees
        {
            if(feesBillPay.equalsIgnoreCase("null"))
            {
                feesNull = 0.0;
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptBillPay.this.finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
                    if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                        connect_to_Printer = new SucessReceiptBillPay.ConnectToPrinter();
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptBillPay.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptBillPay.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptBillPay.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptBillPay.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    SucessReceiptBillPay.PrintToPrinter printToPrinter = new SucessReceiptBillPay.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptBillPay.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptBillPay.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptBillPay.this, mPrinter, bitMap,SucessReceiptBillPay.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_billPay(responseListForPrinter_Body);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptBillPay.this);
        try {
    ...
    private void generateAndSetData() {
       ...
       /* sb.append("{reset}{left}{s}Merchant Name: " + dataList.get(0) + "{br}{br}{br}{br}");
        ...
        responseListForPrinter_Body.add(0, recieptData[12]);    // Merchant Name
        responseListForPrinter_Body.add(1, recieptData[16]);   //  Bill Number:
        responseListForPrinter_Body.add(2, recieptData[10]);   // Customer ID:
        responseListForPrinter_Body.add(3, recieptData[13]);   // Label Name
        responseListForPrinter_Body.add(4, recieptData[9]);  // Customer Name
        ...
        if(recieptData[6].equalsIgnoreCase("null"))
        {
            ...
            responseListForPrinter_Body.add(6, feesBillPay);  // fees
        ...
        {
            responseListForPrinter_Body.add(5, amountBillPay);      //  Amount
            responseListForPrinter_Body.add(6, feesBillPay);     // Fees
        ...
        responseListForPrinter_Body.add(9, recieptData[14]); // Agent Branch Name
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptBillPay.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptBillPay.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptBillPay.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptBillPay.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
