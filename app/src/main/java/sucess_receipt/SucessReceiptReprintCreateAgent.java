...
public class SucessReceiptReprintCreateAgent extends AppCompatActivity implements TaskCompleteToPrint {
...
LinearLayout oldTxnIdLL;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sucess_receipt_reprint_create_agent);
        Toolbar mToolbar;
     ...
     //   agentCode = mComponentInfo.getmSharedPreferences().getString("agentCode", "");
       ...
       // String aa = getIntent().getExtras().getString("data", "");
        ...
        //  Transaction Successful|15/06/2017 18:58:03|2377575585886573441|ftttt|Cameroon
        ...
        subscribeNameReceipt.setText(recieptData[7]);
        agentNameRecepit.setText(recieptData[8]);
        attachBranceNameReceipt.setText(recieptData[6]);

      //  oldTxnIdLL.setVerticalGravity(View.VISIBLE);
        oldTxnidTextViewReceipt.setText(recieptData[9]);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SucessReceiptReprintCreateAgent.this.finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
                    if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                        connect_to_Printer = new SucessReceiptReprintCreateAgent.ConnectToPrinter();
    ...
    private void generateAndSetData() {
        ...
        responseListForPrinter_Body.add(0, recieptData[9]);   //  old Transaction
        responseListForPrinter_Body.add(1, recieptData[2]);   //  Subscriber Number
        responseListForPrinter_Body.add(2, recieptData[7]);   //  Subscriber Name
        responseListForPrinter_Body.add(3, recieptData[6]);   //  Attach Branch name
        responseListForPrinter_Body.add(4, recieptData[4]);   //   City
        responseListForPrinter_Body.add(5, recieptData[5]);  //  Country
        responseListForPrinter_Body.add(6,recieptData[8]);   // Parent Agent name
    }
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(SucessReceiptReprintCreateAgent.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, SucessReceiptReprintCreateAgent.this);
                        ...
                        a++;
                        status = 3;
                        SucessReceiptReprintCreateAgent.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(SucessReceiptReprintCreateAgent.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    SucessReceiptReprintCreateAgent.PrintToPrinter printToPrinter = new SucessReceiptReprintCreateAgent.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(SucessReceiptReprintCreateAgent.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = SucessReceiptReprintCreateAgent.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(SucessReceiptReprintCreateAgent.this, mPrinter, bitMap, SucessReceiptReprintCreateAgent.this);
            mPrintUtils.print_Header(responseListForPrinter_Header);
            mPrintUtils.print_ReprintCreateAgent(responseListForPrinter_Body);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(SucessReceiptReprintCreateAgent.this);
        try {
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(SucessReceiptReprintCreateAgent.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SucessReceiptReprintCreateAgent.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(SucessReceiptReprintCreateAgent.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(SucessReceiptReprintCreateAgent.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
