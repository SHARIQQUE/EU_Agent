...
public class CashToMobileMenu_ReceiveMoney extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cashtomobile_menu_receivemoney);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        if (menuItem.getItemId() == android.R.id.home) {
            ...
            CashToMobileMenu_ReceiveMoney.this.finish();
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.remmitance_send_money_menu:
                ...
                Intent intent=new Intent(CashToMobileMenu_ReceiveMoney.this,RemmettanceReceiveMoneyToMobileTemp.class);
                startActivity(intent);
                // CustomerService.this.finish();
                break;

            case R.id.remmitance_receive_money_menu:
                Intent intent2= new Intent(CashToMobileMenu_ReceiveMoney.this,RemmettanceReceiveMoneyToMobileTempDiffrentCountry.class);
