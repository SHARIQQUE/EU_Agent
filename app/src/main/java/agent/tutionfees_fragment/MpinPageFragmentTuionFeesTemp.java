...
public class MpinPageFragmentTuionFeesTemp extends Fragment implements View.OnClickListener, ServerResponseParseCompletedNotifier {
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.obj.toString().equals("Internet")) {
                ...
                DataParserThread thread = new DataParserThread(getActivity(), mComponentInfo, MpinPageFragmentTuionFeesTemp.this, message.arg1, message.obj.toString());
                thread.execute();
            }
        }
...
//        }
   ...
   public void commentFeesDetails() {
    ...
    String removeLastCharacter(String str) {
        ...
        String[] feesStringFinal_split=str.split("\\|");

        if(feesStringFinal_split.length==1){
            feesStringFinal=feesStringFinal_split[0]+"|NA|NA";
        }else if(feesStringFinal_split.length==2){
            feesStringFinal=feesStringFinal_split[0]+"|"+feesStringFinal_split[1]+"|NA";
        }else  if(feesStringFinal_split.length==3){
            feesStringFinal=feesStringFinal_split[0]+"|"+feesStringFinal_split[1]+"|"+feesStringFinal_split[2];
        }
