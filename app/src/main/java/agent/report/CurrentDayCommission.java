...
public class CurrentDayCommission extends AppCompatActivity implements View.OnClickListener, TextView.OnEditorActionListener, View.OnTouchListener, ServerResponseParseCompletedNotifier, DateSetNotifier, TaskCompleteToPrint {
    ...
    CurrentDayCommission.ConnectToPrinter connect_to_Printer;
    String printdata;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.current_day_commision);
        mComponentInfo = (ComponentMd5SharedPre) getApplicationContext();
    ...
    private boolean validateDetails() {
        boolean ret = false;
                            ...
                            */
                                ...
                                Toast.makeText(CurrentDayCommission.this, getString(R.string.prompt_mPin), Toast.LENGTH_SHORT).show();
                            }
    ...
    void printRequestProcessing() {
        if (askForPermission(Manifest.permission.BLUETOOTH, REQUEST_BLUETOOTH_PHONE)) {
            if (askForPermission(Manifest.permission.BLUETOOTH_ADMIN, REQUEST_BLUETOOTH_PHONE_ADMIN)) {
                connect_to_Printer = new CurrentDayCommission.ConnectToPrinter();
    ...
    private class ConnectToPrinter extends AsyncTask<String, Void, String> {
                    ...
                    try {
                        ...
                        if (printerAddress != null) {
                            ...
                            if (a < 2) {
                                ...
                                mPrinterManager = PrinterManager.getInstance(CurrentDayCommission.this);
                                mPrinterManager.disconnect();
                                Thread.sleep(1500);
                                mPrinterManager.connect(printerAddress, CurrentDayCommission.this);
                        ...
                        a++;
                        status = 3;
                        CurrentDayCommission.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (status) {
                case 0:
                    hideProgressDialog();
                    Toast.makeText(CurrentDayCommission.this, "Bluetooth not supported", Toast.LENGTH_SHORT).show();
                    break;
                ...
                case 2:
                    ...
                    CurrentDayCommission.PrintToPrinter printToPrinter = new CurrentDayCommission.PrintToPrinter();
                ...
                case 3:
                    hideProgressDialog();
                    // commonDisplay.dismissProgressDialog();
                    startActivityForResult(new Intent(CurrentDayCommission.this, PrinterListShowActivity.class), 300);
                    break;
            }
        }
        ...
        protected void onPreExecute() {
            ...
            SharedPreferences sp = CurrentDayCommission.this.getSharedPreferences(CommonUtilities.PREFFS_NAME, 0);
    ...
    private class PrintToPrinter extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            PrintUtils mPrintUtils = new PrintUtils(CurrentDayCommission.this, mPrinter, bitMap, CurrentDayCommission.this);
    ...
    private void showProgressDialog(String message) {
        ...
        mDialog = new ProgressDialog(CurrentDayCommission.this);
        try {
    ...
    private boolean askForPermission(String permission, Integer requestCode) {
        boolean ret = false;
        if (ContextCompat.checkSelfPermission(CurrentDayCommission.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(CurrentDayCommission.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(CurrentDayCommission.this, new String[]{permission}, requestCode);
...
//            }
            ...
            e.printStackTrace();
            Toast.makeText(CurrentDayCommission.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
        }
        return false;
    }
    ...
    void proceedMiniStmt() {
        if (new InternetCheck().isConnected(CurrentDayCommission.this)) {
            showProgressDialog(getString(R.string.pleasewait));
        ...
        //    callApi("getAgentReportComm",requestData,163);
            new ServerTask(mComponentInfo, CurrentDayCommission.this, mHandler, requestData, "getAgentReportComm", 163).start();
        } else {
            Toast.makeText(CurrentDayCommission.this, getString(R.string.pleaseCheckInternet), Toast.LENGTH_LONG).show();
        }
    }
            ...
            JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.POST,getString(R.string.url)+apiName,new JSONObject(body),
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            DataParserThread thread = new DataParserThread(CurrentDayCommission.this,mComponentInfo,CurrentDayCommission.this,requestCode,response.toString());
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            hideProgressDialog();
                            Toast.makeText(CurrentDayCommission.this,getString(R.string.pleaseTryAgainLater),Toast.LENGTH_LONG).show();
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.obj.toString().equals("Internet")) {
                hideProgressDialog();
                Toast.makeText(CurrentDayCommission.this, getString(R.string.pleaseCheckInternet), Toast.LENGTH_SHORT).show();
                ...
                DataParserThread thread = new DataParserThread(CurrentDayCommission.this, mComponentInfo, CurrentDayCommission.this, message.arg1, message.obj.toString());
  ...
  /*  @Override
            ...
            if (generalResponseModel.getResponseCode() == 0) {
                ...
                if (requestNo == 163) {
                    ...
                    if (generalResponseModel.isOTP()) {
                        ...
                        Intent i = new Intent(CurrentDayCommission.this, OTPVerificationActivity.class);
                        ...
                        CurrentDayCommission.this.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (generalResponseModel.getCustomResponseList().size() > 0) {
                                    ...
                                    ReportsCommissionAdapter adapter = new ReportsCommissionAdapter(CurrentDayCommission.this, generalResponseModel.getCustomResponseList(), mComponentInfo.getmSharedPreferences().getBoolean("isOtherAccount", false));
                                    ...
                                    Toast.makeText(CurrentDayCommission.this, getString(R.string.norecordfound), Toast.LENGTH_SHORT).show();
                ...
                hideProgressDialog();
                Toast.makeText(CurrentDayCommission.this, "" + generalResponseModel.getUserDefinedString(), Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        if (menuItem.getItemId() == android.R.id.home) {
            CurrentDayCommission.this.finish();
        }
