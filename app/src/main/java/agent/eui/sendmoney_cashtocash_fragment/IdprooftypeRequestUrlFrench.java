 ...
 */
public class IdprooftypeRequestUrlFrench extends Thread implements MessageFromActivity {
    ...
    public IdprooftypeRequestUrlFrench(ComponentMd5SharedPre componentInfo, Context ctx, Handler mHandler, String body, String apiName, int requestNo) {
        ...
        if (interupt == false) {
            ...
            if (!interupt) {
              ...
              //  Log.e("http end-" + requestNo, "Response Json  - image -> " + webResponse);
                ...
                webResponse = "[{\"code\":\"NIC\",\"libelle\":\"Carte Nationale d'Identité\"},{\"code\":\"PASSPORT\",\"libelle\":\"Passeport\"},{\"code\":\"DRVLIC\",\"libelle\":\"Permi de Conduire\"},{\"code\":\"VOTRID\",\"libelle\":\"Carte d Electeur\"}]";
