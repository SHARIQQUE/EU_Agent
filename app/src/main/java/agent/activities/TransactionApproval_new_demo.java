 ...
 */
public class TransactionApproval_new_demo extends AppCompatActivity implements View.OnClickListener, TextView.OnEditorActionListener, ServerResponseParseCompletedNotifier, AdapterView.OnItemSelectedListener {
...
*/
    ...
    private boolean validateDetailsPart1() {
        ...
        if (spinner_OperationType.getSelectedItemPosition() > 0) {
            ...
            if (approvalNoString.length() >= 4) {
                ...
                Toast.makeText(TransactionApproval_new_demo.this, getString(R.string.pleaseEnterApprovalNumber), Toast.LENGTH_SHORT).show();
            }
           /* } else {
            ...
            Toast.makeText(TransactionApproval_new_demo.this, getString(R.string.PleaseSelectOperationType), Toast.LENGTH_SHORT).show();
        }
        return ret;
    }
    ...
    private void showAccToCashReview() {
        ...
        TransactionApproval_new_demo.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                hideKeyboard();
    ...
    private boolean validateDetailsPart2() {
        ...
        if (mpinString.trim().length() == 4) {
            ...
            Toast.makeText(TransactionApproval_new_demo.this, getString(R.string.prompt_mPin), Toast.LENGTH_SHORT).show();
        }
    /*    } else {
    ...
    public void pictureSignatureServerRequest() {
      ...
      //  callApi("getViewProfileInJSON",requestData,148);
        ...
        new ServerTask(mComponentInfo, TransactionApproval_new_demo.this, mHandler, requestData, "getViewProfileInJSON", 148).start();
    }
            ...
            JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.POST,getString(R.string.url)+apiName,new JSONObject(body),
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            DataParserThread thread = new DataParserThread(TransactionApproval_new_demo.this,mComponentInfo,TransactionApproval_new_demo.this,requestCode,response.toString());
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            hideProgressDialog();
                            Toast.makeText(TransactionApproval_new_demo.this,getString(R.string.pleaseTryAgainLater),Toast.LENGTH_LONG).show();
    ...
    void proceedTransactionApproval() {
        if (new InternetCheck().isConnected(TransactionApproval_new_demo.this)) {
            showProgressDialog(getString(R.string.pleasewait));
          ...
          //  callApi("getApproveTransactionInJSON",requestData,128);
            ...
            new ServerTask(mComponentInfo, TransactionApproval_new_demo.this, mHandler, requestData, "getApproveTransactionInJSON", 128).start();

        } else {
            Toast.makeText(TransactionApproval_new_demo.this, getString(R.string.pleaseCheckInternet), Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void proceedApprove() {    // getApproveViewTransactionInJSON  second API Call
     ...
     //   callApi("getApproveViewTransactionInJSON",requestData,131);
        ...
        new ServerTask(mComponentInfo, TransactionApproval_new_demo.this, mHandler, requestData, "getApproveViewTransactionInJSON ", 131).start();
    }
    ...
    private void showProgressDialog(String message) {
        mDialog = new ProgressDialog(TransactionApproval_new_demo.this);
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.obj.toString().equals("Internet")) {
                hideProgressDialog();
                Toast.makeText(TransactionApproval_new_demo.this, getString(R.string.pleaseCheckInternet), Toast.LENGTH_SHORT).show();
                return;
            } else if (message.obj.toString().equals("")) {
                hideProgressDialog();
                Toast.makeText(TransactionApproval_new_demo.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();
            } else {
                DataParserThread thread = new DataParserThread(TransactionApproval_new_demo.this, mComponentInfo, TransactionApproval_new_demo.this, message.arg1, message.obj.toString());
                thread.execute();
            }
        }
   ...
   */
        ...
        TransactionApproval_new_demo.this.finish();
    }
        ...
        if (generalResponseModel.getResponseCode() == 0 || requestNo == 148) {
            ...
            if (requestNo == 128) {
                if (generalResponseModel.isOTP()) {
                    ...
                    Intent i = new Intent(TransactionApproval_new_demo.this, OTPVerificationActivity.class);
            ...
            Toast.makeText(TransactionApproval_new_demo.this, "" + generalResponseModel.getUserDefinedString(), Toast.LENGTH_SHORT).show();
        }
    }
