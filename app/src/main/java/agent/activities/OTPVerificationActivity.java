...
public class OTPVerificationActivity extends AppCompatActivity implements ServerResponseParseCompletedNotifier, AutoCompleteTextView.OnEditorActionListener, View.OnClickListener {
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message message) {
            ...
            if (message.obj.toString().equals("Internet")) {
                ...
                // canExitApp = true;
                Toast.makeText(OTPVerificationActivity.this, getString(R.string.pleaseCheckInternet), Toast.LENGTH_SHORT).show();
                return;
            } else if (message.obj.toString().equals("")) {
                hideProgressDialog();
                Toast.makeText(OTPVerificationActivity.this, getString(R.string.pleaseTryAgainLater), Toast.LENGTH_SHORT).show();

            } else {


                DataParserThread thread = new DataParserThread(OTPVerificationActivity.this, mComponentInfo, OTPVerificationActivity.this, message.arg1, message.obj.toString());
...
// can be made blocking using Tasks.await(task, [timeout]);
    ...
    private void showProgressDialog(String message) {
        mDialog = new ProgressDialog(OTPVerificationActivity.this);
    ...
    private void startServerInteractionForResendOTP() {
        if (new InternetCheck().isConnected(OTPVerificationActivity.this)) {
            showProgressDialog(getString(R.string.sendingotp));
            new ServerTask(mComponentInfo, OTPVerificationActivity.this, mHandler, generateResendOtpData(), "resendOTPInJSON", 117).start();
        } else {
            Toast.makeText(OTPVerificationActivity.this, getString(R.string.pleaseCheckInternet), Toast.LENGTH_SHORT).show();
            //canExitApp = true;
        }
    ...
    private void startServerInteraction() {
        if (new InternetCheck().isConnected(OTPVerificationActivity.this)) {
            ...
            new ServerTask(mComponentInfo, OTPVerificationActivity.this, mHandler, generateOtpData(), "getOTPInJSON", 103).start();
        } else {
            Toast.makeText(OTPVerificationActivity.this, getString(R.string.pleaseCheckInternet), Toast.LENGTH_SHORT).show();
            //canExitApp = true;
        }
    ...
    private String generateResendOtpData() {
        ...
        try {
            ...
            countryObj.put("transtype", process);
    ...
    private boolean checkDetails() {
        ...
        //    if (isPermissionsProvided()) {
           ...
           /* } else {
                Toast.makeText(OTPVerificationActivity.this, getString(R.string.PleaseProvidePermissions), Toast.LENGTH_LONG).show();

            }*/
        } else {


            Toast.makeText(OTPVerificationActivity.this, getString(R.string.restartapp), Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                switch (process) {
                    case "LOGIN":
                        i = new Intent(OTPVerificationActivity.this, LoginActivity.class);
                        hideProgressDialog();
                        startActivity(i);
    ...
    public void onParsingCompleted(GeneralResponseModel generalResponseModel, ArrayList<Object> customResponseList, int requestNo) {
        ...
        if (generalResponseModel.getResponseCode() == 0) {
            switch (requestNo) {
                ...
                case 104:
                    hideProgressDialog();
                    Toast.makeText(OTPVerificationActivity.this, getString(R.string.YouHavebeenSuccessfullyActivatedPleaseLogin), Toast.LENGTH_SHORT).show();
                    try {
                        Thread.sleep(100);
                    } catch (Exception e) {
                    }
            ...
            hideProgressDialog();
            Toast.makeText(OTPVerificationActivity.this, "" + generalResponseModel.getUserDefinedString(), Toast.LENGTH_SHORT).show();
            if (requestNo != 117) {
                Toast.makeText(OTPVerificationActivity.this, "" + generalResponseModel.getUserDefinedString(), Toast.LENGTH_SHORT).show();
